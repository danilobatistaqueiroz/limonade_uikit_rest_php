...
<html lang="en-gb" dir="ltr">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../libs/uikit.docs.min.css">
...
-->
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-1-1 uk-text-center">
                    ...
                    <p class="uk-text-large">I want to receive feedbacks :)</p>
                </div>
            </div>
<!--
            <div class="uk-grid" data-uk-grid-margin>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="uk-width-medium-1-3">
                    <div class="uk-panel uk-panel-box uk-panel-box-secondary">
                        ...
                        <p>
                            <strong>Danilo Batista Queiroz</strong>
                            <br>Rua Heitor Penteado, São Paulo, SP
                            <br>Brasil
                        </p>
                        <p>
                            <a>danilobatistaqueiroz@gmail.com</a>
                            <br><a>https://gist.github.com/danilobatistaqueiroz</a><br>
                            Phone: +55 (011) 9.6451-5485
                        </p>
